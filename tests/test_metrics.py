...
import torch
import pytest
from src.utils.metrics import compute_map_range, _to_coco_format
...
def _make_perfect_pair(n_boxes=3, num_classes=2):
    ...
    boxes = torch.tensor([[10., 10., 50., 50.],
                          [60., 60., 120., 120.],
                          [5., 5., 30., 30.]], dtype=torch.float32)[:n_boxes]
...
class TestToCocoFormat:
    ...
    def test_empty_predictions(self):
        preds = [{'boxes': torch.zeros(0, 4), 'labels': torch.zeros(0, dtype=torch.long),
